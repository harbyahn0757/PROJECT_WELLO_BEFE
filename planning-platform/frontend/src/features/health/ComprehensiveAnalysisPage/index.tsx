...
const ComprehensiveAnalysisPage: React.FC = () => {
  ...
  const analyzeHealthData = useCallback(async () => {
    ...
    try {
      ...
      const healthDataForAPI = healthData.map((item: any) => ({
        ...item,
        // 필요한 필드들 확인 및 변환
      ...
      const prescriptionDataForAPI = prescriptionData.map((item: any) => ({
        ...item,
        // 필요한 필드들 확인 및 변환
  ...
  const validateChartData = useCallback((data: any) => {
    ...
    if (Array.isArray(data) && data.length > 0 && data[0].data) {
      ...
      })).filter((series: any) => series.data && series.data.length > 0);
    }
  ...
  const healthChartData = useMemo(() => {
    ...
    try {
      ...
      })).filter((series: any) => series.data[0].value > 0);
    ...
    <div className="health-data-viewer">
      <div className="question__content">
            ...
            <div className="health-metrics-wrapper">
              ...
              {Array.from({ length: 12 }, (_, index) => {
                ...
                const getLatestHealthData = () => {
                  ...
                  const sortedData = [...healthData].sort((a: any, b: any) => {
                    ...
                    <div className="metric-chart">
                      {(() => {
                        ...
                        if (dataCount === 0) {
                          ...
                          const validData = metricChartData[0]?.data?.filter((point: any) => 
                            point && 
                            point.value > 0 && 
                            !isNaN(point.value) && 
                            isFinite(point.value) &&
        ...
        <div className="insights-grid">
                  {gptAnalysis.insights.map((insight: any, index: number) => (
        ...
        {gptAnalysis?.nutritionRecommendations && (
              ...
              <div className="nutrition-grid">
                ...
                <div className="nutrition-section avoid-section">
                  ...
                  <div className="nutrition-list">
                    {gptAnalysis.nutritionRecommendations.avoid.map((food: any, index: number) => (
          ...
          <div className="section-header">
                  ...
                  <div className="nutrition-list">
                    {gptAnalysis.nutritionRecommendations.recommend.map((food: any, index: number) => (
